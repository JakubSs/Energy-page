<div align="center"><?php
      ...
      function drawChart() {";
        ...
        echo "var data = new google.visualization.DataTable();
          ...
          ";
                ...
                var chart = new google.visualization.AnnotationChart(document.getElementById('chart_divVodaTepla'));
  ...
  ";
    echo "    <div id='chart_divVodaTepla' style='width: 900px; height: 300px;'></div>";
            }
        }
    } else {
