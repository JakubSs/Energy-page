<div align="center"><?php
    ...
    <script type='text/javascript'>
      ...
      function drawChart() {";
        ...
        echo "var data = new google.visualization.DataTable();
          ...
          [new Date($rok, $mesiac, $den),  $row2[stav]],
          ";
                }
                echo " ]);

                var chart = new google.visualization.AnnotationChart(document.getElementById('chart_divPlyn'));
  ...
  ";
    echo "    <div id='chart_divPlyn' style='width: 900px; height: 300px;'></div>";
            }
        }
    } else {
