<div align="center"><?php
        ...
        echo "var data = new google.visualization.DataTable();
            ...
            if (mysqli_connect_errno($con)) {
                ...
                while ($row2 = mysqli_fetch_array($result2)) {
                    ...
                    $priemer=(($row2[stav]-$lastVoda)/$days_betwvodan);
          ...
          ";
                ...
                var chart = new google.visualization.AnnotationChart(document.getElementById('chart_divVodaPriemer'));
  ...
  ";
    echo "    <div id='chart_divVodaPriemer' style='width: 900px; height: 200px;'></div>";
