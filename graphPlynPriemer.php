<div align="center"><?php
      ...
      function drawChart() {";
        ...
        echo "var data = new google.visualization.DataTable();
            ...
            if (mysqli_connect_errno($con)) {
                ...
                while ($row2 = mysqli_fetch_array($result2)) {
                   $tempDni = $row2['datum'];
                    ...
                    $priemer=(($row2[stav]-$lastPlyn)/$days_between);
                    echo "  
          ...
          ";
                ...
                var chart = new google.visualization.AnnotationChart(document.getElementById('chart_divPlynPriemer'));
  ...
  ";
    echo "    <div id='chart_divPlynPriemer' style='width: 900px; height: 200px;'></div>";
